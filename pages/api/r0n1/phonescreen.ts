...
export default async function handler(
  ...
  if (Number(tokenId) < 1) {
    ...
    var uwuApiRes = await fetch(`https://storageapi.fleek.co/435d6632-997b-499f-a7f3-40d99af1e173-bucket/r0n1-world/${tokenId}`)
    ...
    await Jimp.read(imageUrl, async function (err, image) {
      ...
      var logoFilePath = path.resolve('.', 'assets/ron1_logo.png')
