...
export default function Karafuru() {
...
`}</style>
    <div className="pt-4 pl-4">
      ...
      <img src="./karafuru/karafuru_logo.png" alt="" width="500" height="72" />
    </div>
      ...
      onSubmit={async (e: React.SyntheticEvent) => {
        ...
        var res = await fetch(`/api/karafuru/phonescreen?tokenId=${tokenId}`)
        setLoading(false)
        if (res.status == 400) {
            setFailedFetch(true)
        } else {
